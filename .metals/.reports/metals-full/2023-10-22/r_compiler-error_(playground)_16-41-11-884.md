...
scala.collection.mutable.ArrayBuffer.apply(ArrayBuffer.scala:98)
	...
	scala.tools.nsc.typechecker.Unapplies.directUnapplyMember(Unapplies.scala:43)
	scala.tools.nsc.typechecker.Unapplies.directUnapplyMember$(Unapplies.scala:43)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.directUnapplyMember(MetalsGlobal.scala:67)
	scala.tools.nsc.typechecker.Unapplies.unapplyMember(Unapplies.scala:51)
	scala.tools.nsc.typechecker.Unapplies.unapplyMember$(Unapplies.scala:48)
	scala.meta.internal.pc.MetalsGlobal$MetalsInteractiveAnalyzer.unapplyMember(MetalsGlobal.scala:67)
	scala.tools.nsc.typechecker.Unapplies$HasUnapply$.unapply(Unapplies.scala:74)
	scala.tools.nsc.typechecker.Typers$Typer.doTypedApply(Typers.scala:3858)
