...
void isa_difftest_attach(void *buf,int *len) {
  *len=16*4;
  ...
  inst[1]=(0x737)|((num[0]/12)<<12);  //lui   a4 num/12
  inst[2]=(0x713)|((num[0]%12)<<20);  //addi  a4 a4 num%12
  inst[3]=0x30071073;                 //csrrw $0 mstatus a4
  inst[4]=0x00000713;                 //addi  a4 $0  0
  inst[5]=(0x737)|((num[0]/12)<<12);  //lui   a4 num/12
  inst[6]=(0x713)|((num[0]%12)<<20);  //addi  a4 a4 num%12
  inst[7]=0x30571073;                 //csrrw $0 mtvec a4
  inst[8]=0x00000713;                 //addi  a4 $0  0
  inst[9]=(0x737)|((num[0]/12)<<12);  //lui   a4 num/12
  inst[10]=(0x713)|((num[0]%12)<<20); //addi  a4 a4 num%12
  inst[11]=0x34171073;                //csrrw $0 mepc  a4
  inst[12]=0x00000713;                //addi  a4 $0  0
  inst[13]=(0x737)|((num[0]/12)<<12); //lui   a4 num/12
  inst[14]=(0x713)|((num[0]%12)<<20); //addi  a4 a4 num%12
