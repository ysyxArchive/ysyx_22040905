...
void isa_difftest_attach(uint32_t *buf,int *len) {
  *len=40*4;
  ...
  buf[12]=(0x713)|(BITS(cpu.mtvec,43,32)<<20);  //addi  a4,a4,num[43,32]
  buf[13]=0x0c71713;                         //slli a4,a4,0x0c
  buf[14]=(0x713)|(BITS(cpu.mtvec,31,20)<<20);  //addi  a4,a4,num[31,20]
  buf[15]=0x0c71713;                         //slli a4,a4,0x0c
  buf[16]=(0x713)|(BITS(cpu.mtvec,19,8)<<20);   //addi  a4,a4,num[19,8]
  buf[17]=0x0871713;                         //slli a4,a4,0x08
  buf[18]=(0x713)|(BITS(cpu.mtvec,7,0)<<20);    //addi  a4,a4,num[7,0]
  buf[19]=0x30571073;                        //csrrw $0,mtvec,a4

  
  buf[20]=0x00000713;                        //addi  a4,$0,0
  buf[21]=(0x737)|(BITS(cpu.mepc,63,44)<<12);  //lui   a4,num[63,44]
  buf[22]=(0x713)|(BITS(cpu.mepc,43,32)<<20);  //addi  a4,a4,num[43,32]
  buf[23]=0x0c71713;                         //slli a4,a4,0x0c
  buf[24]=(0x713)|(BITS(cpu.mepc,31,20)<<20);  //addi  a4,a4,num[31,20]
  buf[25]=0x0c71713;                         //slli a4,a4,0x0c
  buf[26]=(0x713)|(BITS(cpu.mepc,19,8)<<20);   //addi  a4,a4,num[19,8]
  buf[27]=0x0871713;                         //slli a4,a4,0x08
  buf[28]=(0x713)|(BITS(cpu.mepc,7,0)<<20);    //addi  a4,a4,num[7,0]
  buf[29]=0x34171073;                        //csrrw $0,mepc,a4

  
  buf[30]=0x00000713;                        //addi  a4,$0,0
  buf[31]=(0x737)|(BITS(cpu.mcause,63,44)<<12);  //lui   a4,num[63,44]
  buf[32]=(0x713)|(BITS(cpu.mcause,43,32)<<20);  //addi  a4,a4,num[43,32]
  buf[33]=0x0c71713;                         //slli a4,a4,0x0c
  buf[34]=(0x713)|(BITS(cpu.mcause,31,20)<<20);  //addi  a4,a4,num[31,20]
  buf[35]=0x0c71713;                         //slli a4,a4,0x0c
  buf[36]=(0x713)|(BITS(cpu.mcause,19,8)<<20);   //addi  a4,a4,num[19,8]
  buf[37]=0x0871713;                         //slli a4,a4,0x08
  buf[38]=(0x713)|(BITS(cpu.mcause,7,0)<<20);    //addi  a4,a4,num[7,0]
