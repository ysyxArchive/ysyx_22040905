...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli   , I, R(dest) = SEXT(BITS(src1<<SEXT(BITS(src2,4,0),5),31,0),32));
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli   , I, R(dest) = SEXT(BITS(src1>>SEXT(BITS(src2,4,0),5),31,0),32));
