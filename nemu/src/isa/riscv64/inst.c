...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli   , I, printf("r:%ld %lld\n",src1,(BITS(src2,4,0))); R(dest) = (src1>>(BITS(src2,4,0))));
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli   , I, printf("l:%ld %ld %lld\n",src1<<(BITS(src2,4,0)),src1,(BITS(src2,4,0))); R(dest) = (src1<<BITS(src2,4,0)));
