...
static word_t immB(uint32_t i) { printf("%x %llx\n",i,((BITS(i, 31, 31)) << 12)|((BITS(i, 30, 25)) << 5)|((BITS(i, 11, 8)) << 1)|((BITS(i, 7, 7)) << 11)); return (SEXT(BITS(i, 31, 31), 1) << 12)| (SEXT(BITS(i, 30, 25), 6) << 5)|(SEXT(BITS(i, 11, 8), 4) << 1)|(SEXT(BITS(i, 7, 7), 1) << 11);}
