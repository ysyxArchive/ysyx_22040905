...
#define INSTPAT_MATCH(s, name, type, ... /* body */ ) { \
  ...
  INSTPAT("0000000 ????? ????? 101 ????? 00100 11", srli   , I, R(dest) = (uint64_t)(src1>>SEXT(BITS(src2,4,0),5)));
  INSTPAT("0000000 ????? ????? 001 ????? 00100 11", slli   , I, R(dest) = (uint64_t)(src1<<SEXT(BITS(src2,4,0),5)));
