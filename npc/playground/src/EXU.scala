...
class EXU extends Module{
    val io=IO(new Bundle{
        ...
        state:=MuxLookup(state,s_idle,List(
            ...
            s_wait -> Mux((lsu.io.ls.out.fire | ((~op_r) & (~op_w))).asBool,s_wait_next,s_wait),
        ...
        io.out.bits.csr.val_w:=Mux(EXE_reg_op(63),src1,
                      Mux(EXE_reg_op(64),alu_dest.io.result,
                      0.U))
        ...
        lsu.io.ls.in.bits.raddr:=Mux(EXE_reg_op(38)|EXE_reg_op(39)|EXE_reg_op(40)|EXE_reg_op(41)|EXE_reg_op(46)|EXE_reg_op(47)|EXE_reg_op(48),alu_dest.io.result,0.U)
        lsu.io.ls.in.bits.waddr:=Mux(EXE_reg_op(42)|EXE_reg_op(43)|EXE_reg_op(44)|EXE_reg_op(45),alu_dest.io.result,0.U)
        ...
        alu_dest.io.src2:=Mux(EXE_reg_op(13)|EXE_reg_op(17)|EXE_reg_op(21),Cat(Fill(59,0.U),src2(4,0)),
                          ...
                          src2))))))
        alu_dest.io.op  :=Mux(EXE_reg_op(0)|EXE_reg_op(1)|EXE_reg_op(2)|EXE_reg_op(3)|EXE_reg_op(24)|EXE_reg_op(25)|EXE_reg_op(36)|EXE_reg_op(37)|EXE_reg_op(38)|EXE_reg_op(39)|EXE_reg_op(40)|EXE_reg_op(41)|EXE_reg_op(42)|EXE_reg_op(43)|EXE_reg_op(44)|EXE_reg_op(45)|EXE_reg_op(46)|EXE_reg_op(47)|EXE_reg_op(48),1.U, //add
        ...
        alu_pc.io.src2:=Mux(EXE_reg_op(30)&alu_dest.io.result(0),dest,
                        ...
                        Mux(EXE_reg_op(33)&(~alu_dest.io.result(0)),dest,
                        Mux(EXE_reg_op(34)&alu_dest.io.result(0),dest,
                        Mux(EXE_reg_op(35)&alu_dest.io.result(0),dest,
                        Mux(EXE_reg_op(36),src1,
                        Mux(EXE_reg_op(37),src2,
                        4.U))))))))
        alu_pc.io.op:=  Mux(EXE_reg_op(37),1024.U,1.U)
