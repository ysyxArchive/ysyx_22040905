...
class EXU extends Module{
    val io=IO(new Bundle{
        ...
        op_mul:=EXE_reg_op(12)|EXE_reg_op(13)|EXE_reg_op(14)
        op_div:=EXE_reg_op(15)|EXE_reg_op(16)|EXE_reg_op(17)|EXE_reg_op(18)
        ...
        io.out.bits.gpr.val_w:=Mux(EXE_reg_op(1)|EXE_reg_op(3)|EXE_reg_op(5)|EXE_reg_op(13)|EXE_reg_op(15)|EXE_reg_op(17)|EXE_reg_op(21)|EXE_reg_op(23)|EXE_reg_op(51)|EXE_reg_op(56)|EXE_reg_op(60)|EXE_reg_op(62),Cat(Fill(32,alu.io.result(31)),alu.io.result(31,0)), 
                      Mux(EXE_reg_op(52)|EXE_reg_op(53)|EXE_reg_op(54),Cat(Fill(32,0.U),alu.io.result(63,32)),
