  ...
  val io = IO(new Bundle {
   ...
   io.Carry:=false.B
    ...
    when(io.Result%10.U===0.U){
        ...
        b:="b000000000000000011101101".U^a
    ...
    when(io.Result%10.U===0.U){
        c:="b111111111111111111000000".U 
    }.elsewhen(io.Result/10.U%10.U===0.U){
        c:="b000000001100000000000000".U^b
