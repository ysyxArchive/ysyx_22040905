...
val io=IO( new Bundle{
  ...
  result := (adder_a.asUInt + adder_b.asUInt(132,0) + sw.cout(0))(127,0)
...
class Wallace extends Module{
  ...
  val a = Wire(UInt(132.W))
  val b = Wire(UInt(66.W))
